...
export const EPDWizard: React.FC<EPDWizardProps> = ({ onClose }) => {
  ...
  // Load once from local storage (or defaults).
  ...
  // Auto-save the entire form whenever it changes.
  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ Clear saved draft so the wizard starts fresh next time
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({ ...prev, functional_unit: value }))
                }
              >
      ...
      case 2:
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    manufacturer_location: e.target.value
                  }))
                }
            ...
            <div>
              <Label htmlFor="manufacturer_abn">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    manufacturer_abn: e.target.value
                  }))
                }
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateMaterial(index, 'quantity', asFloat(e.target.value))
                      }
                      className="mt-1"
                    />
                  </div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        energy: {
                          ...prev.energy,
                          electricity: asFloat(e.target.value)
                        }
                      }))
                    }
                    className="mt-1"
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setFormData((prev) => ({
                        ...
                        energy: {
                          ...prev.energy,
                          renewable_percentage: asInt(e.target.value)
                        }
                      }))
                    }
                    className="mt-1"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...
                      waste: {
                        ...prev.waste,
                        recycling_rate: asInt(e.target.value)
                      }
                    }))
                  }
                  className="mt-1"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...
                      waste: {
                        ...prev.waste,
                        landfill_rate: asInt(e.target.value)
                      }
                    }))
                  }
                  className="mt-1"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...
                      waste: {
                        ...prev.waste,
                        incineration_rate: asInt(e.target.value)
                      }
                    }))
                  }
                  className="mt-1"
